...
int main(int argc, char* argv[]){
  ...
  printf("Temps moyen d'éxecution pour créer le dico sur %d répétitions avec l'arbre radix : %.3Lf s\n",repeat,moyenne1);
  printf("Temps moyen d'éxecution pour verifier le texte sur %d répétitions avec l'arbre radix : %.3Lf s\n",repeat,moyenne2);
  return EXIT_SUCCESS;
}